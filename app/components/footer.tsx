...
export function Footer() {
  const supportLink = process.env.NEXT_PUBLIC_SUPPORT_URL || "/#pilot-lead-form";
    ...
    >
      ...
      <ul className="flex list-none flex-wrap gap-x-6 gap-y-3">
        {[
          ...
          { label: "Privacy / Compliance", href: "/docs/api-reference" },
          { label: "System Status", href: "/docs/docker-pilot-guide" },
        ].map((link) => (
          <li key={link.label}>
            <Link
              href={link.href}
